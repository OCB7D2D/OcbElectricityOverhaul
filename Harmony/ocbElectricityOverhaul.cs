...
public class OcbElectricityOverhaul : IModApi
{
    ...
    public class Block_GetCustomDescription
    {
        ...
        public static string GetRepairText(PowerSource source)
        {
            string str; 
        ...
        public static string GetBatteryState(PowerBatteryBank bank)
        {
            string str;
        ...
        public static string GetFuelState(PowerGenerator generator)
        {
            ...
            ref string __result)
        {
            ...
            {
                if (PowerManager.Instance.PowerItemDictionary
                    .TryGetValue(_blockPos, out PowerItem pw))
                {
                    ...
                    else if (pw is PowerBatteryBank bank)
                    {
                        AppendLine(ref __result, string.Format(
