...
# We must disable eac, but we may want to use vulcan instead of glcore?
executable_params="-logfile output.log -force-glcore -nogs -noeac"
...
"${executable_path}" ${executable_params}
